...
const ChatUI = {
    ...
    showYukinoRegistrationButtons() {
        ...
        yesButton.onclick = () => {
            console.log('[雪乃登録確認] 「はい」がクリックされました');
            window.handleYukinoRegistrationConsent(true);
        };
        ...
        noButton.onclick = () => {
            console.log('[雪乃登録確認] 「いいえ」がクリックされました');
            window.handleYukinoRegistrationConsent(false);
        };
