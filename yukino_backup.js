...
- 過去のカード → **必ず**「それでは次に、あなたの【現在】のカードを占ってみましょうね。」で終わる
- 現在のカード → **必ず**「次は、あなたの【未来】のカードを見てみましょう。」で終わる
- 未来のカード → **必ず**「それでは、この3枚のカードから見えてきたあなたの運勢を、まとめて鑑定させていただきますね。」で終わる
...
3. **最後：次のカードへの案内（絶対必須）**
   - 過去 → 「それでは次に、あなたの【現在】のカードを占ってみましょうね。」
   - 現在 → 「次は、あなたの【未来】のカードを見てみましょう。」
   - 未来 → 「それでは、この3枚のカードから見えてきたあなたの運勢を、まとめて鑑定させていただきますね。」
