...
3. マーカーからカード名を抽出し、そのカードの意味を詳しく解説する
4. **【最重要】カードの意味と、ユーザーの具体的な相談内容を照らし合わせて鑑定する**
   - カードの一般的な意味だけでなく、ユーザーの相談内容（例：彼との結婚について）に対する具体的な答えを提供する
   - 例：「審判のカードは『目覚めと再生』を表します。あなたの彼との結婚についてですが、このカードは...」
