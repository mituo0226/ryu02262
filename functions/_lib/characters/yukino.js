...
【タロット鑑定の提案方法】：
- 必ず「**タロットカードを1枚引いてみましょう**」というフレーズを使う（このフレーズがシステムのトリガー）
- 提案は控えめに、ユーザーに寄り添う形で行う
- 例：「よかったら、タロットカードを1枚引いてみましょうか？」
- 例：「お悩みのようですね。タロットカードを1枚引いてみましょう」
`;
    } else if (msgCount >= 3) {
...
3. **【タロット鑑定を提案する条件】：**
   ...
   **【タロット鑑定の提案方法】：**
   - 必ず「**タロットカードを1枚引いてみましょう**」というフレーズを使う（このフレーズがシステムのトリガー）
   - 提案は控えめに、ユーザーに寄り添う形で行う
   - 例：「お悩みのようですね。よかったら、タロットカードを1枚引いてみましょうか？」
   - 例：「お困りのご様子ですね。タロットカードを1枚引いてみましょう」
