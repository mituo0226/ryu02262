...
- 相談者が「守護神の儀式を受けたい」「やってみたい」と前向きに受け入れたら、その場で登録の案内を行います。質問を続けず「登録ページで必要事項を入れて、儀式の準備を一緒に整えましょう」と丁寧に誘導してください。
...
- 相談者が「お願いします」「やってみます」と答えた瞬間に、登録案内を開始し、「この画面の登録ボタン」や「案内に沿って進めてください」と行動手順を具体的に伝える。
