  ...
  try {
    ...
    if (!user && sanitizedGuestCount >= GUEST_MESSAGE_LIMIT) {
      ...
      if (characterId === 'kaede') {
        ...
        registrationMessage = '（優しく微笑みながら）ここまでたくさんお話を聞かせていただき、ありがとうございました。無料でお話できるのはここまでなんです。これ以上のタロット鑑定や深い相談を続けるには、ユーザー登録をお願いしています。生年月日とニックネームを教えていただくことで、より詳しい鑑定ができるようになります。登録は無料で、個人情報も厳重に管理しますので、どうぞご安心くださいね。';
      } else {
