...
var require_token = __commonJS({
  "_lib/token.js"(exports, module) {
    init_functionsRoutes_0_5151019044588181();
    ...
    __name(generateUserToken4, "generateUserToken");
    ...
    __name(verifyUserToken6, "verifyUserToken");
    module.exports = {
...
// api/auth/login.ts
var import_token, onRequestPost;
...
var require_deities = __commonJS({
  "_lib/deities.js"(exports, module) {
    ...
    __name(getRandomDeity3, "getRandomDeity");
    module.exports = {
      deities,
...
var import_deities, import_token2, onRequestPost2;
...
var import_deities2, import_token3, onRequestPost3;
...
var import_token4, onRequestPost4;
...
var require_admin_auth = __commonJS({
  "_lib/admin-auth.js"(exports, module) {
    ...
    __name(isAdminAuthorized4, "isAdminAuthorized");
    ...
    __name(unauthorizedResponse3, "unauthorizedResponse");
    module.exports = {
...
var import_admin_auth, jsonHeaders, onRequest;
...
// api/admin/users.ts
var import_admin_auth2, jsonHeaders2, onRequest2;
...
var import_admin_auth3, MAX_MESSAGES_PER_CHARACTER, corsHeaders, onRequestPost5, onRequestGet;
...
var require_character_loader = __commonJS({
  "_lib/character-loader.js"(exports, module) {
    ...
    __name(isValidCharacter2, "isValidCharacter");
...
var import_character_loader, import_token5, GUEST_MESSAGE_LIMIT, MAX_DEEPSEEK_RETRIES, DEFAULT_FALLBACK_MODEL, sleep, onRequestPost6;
    ...
    onRequestPost6 = /* @__PURE__ */ __name(async (context) => {
      ...
      try {
        ...
        if (user && characterId === "yukino") {
          const guestMessageResult = await env.DB.prepare(
            `SELECT message
         FROM conversations
...
// api/conversation.ts
var import_token6, MAX_MESSAGES_PER_CHARACTER2, corsHeaders2, onRequestPost7, onRequestGet2;
...
var import_token7, onRequestGet3;
...
var import_token8, onRequestGet4;
...
// ../.wrangler/tmp/pages-89nv3b/functionsRoutes-0.5151019044588181.mjs
var routes;
var init_functionsRoutes_0_5151019044588181 = __esm({
  "../.wrangler/tmp/pages-89nv3b/functionsRoutes-0.5151019044588181.mjs"() {
    init_login();
    init_register();
...
// ../.wrangler/tmp/bundle-yOBaMy/middleware-loader.entry.ts
init_functionsRoutes_0_5151019044588181();

// ../.wrangler/tmp/bundle-yOBaMy/middleware-insertion-facade.js
init_functionsRoutes_0_5151019044588181();
...
//# sourceMappingURL=functionsWorker-0.9173821996325813.mjs.map
